...
class ArticleFragment : Fragment() {
    ...
    private fun showLoadingRekomendasi(isLoading: Boolean) {
        binding.loadingRekomendasiBar.visibility = if (isLoading) View.VISIBLE else View.GONE
    }
}
